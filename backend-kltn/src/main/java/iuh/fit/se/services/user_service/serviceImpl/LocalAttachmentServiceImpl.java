...
public class LocalAttachmentServiceImpl implements AttachmentService {
	...
	public Attachment uploadAttachment(String userId, MultipartFile file) {
		...
		Attachment attachment = Attachment.builder()
			...
			.height(200)
			.width(200)
			.url("https://images.steamusercontent.com/ugc/2020477638665804166/24A9F61D7CCB7CBB1115DE608CF491A59848BBE5/?imw=512&imh=515&ima=fit&impolicy=Letterbox&imcolor=%23000000&letterbox=true")
			.size(file.getSize())
			.build();
